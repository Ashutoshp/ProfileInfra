...
CloudSpecGenerator::CloudSpecGenerator(const string& dir): SpecGenerator(dir) {

}

// CUSTOMIZED
bool CloudSpecGenerator::write_initial_state(ofstream& fout) const {
...
bool CloudSpecGenerator::write_flags(ofstream& fout, const Strings& actions) const {
...
// CUSTOMIZED
bool CloudSpecGenerator::fix_reactive_actions(ofstream& fout, const bool& no_action) const {
	bool result = false;
	Strings actions;
...
bool CloudSpecGenerator::copy_template_file(ofstream& fout) const {
...
bool CloudSpecGenerator::generate_specs() const {
	bool result = false;
...
bool CloudSpecGenerator::generate_hybrid_spec() const {
	bool result = false;
...
bool CloudSpecGenerator::generate_deliberative_spec() const {
	bool result = false;
	// Open output file to write modified specification for model-checking
